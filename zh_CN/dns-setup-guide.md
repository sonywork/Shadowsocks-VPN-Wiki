...
![打开控制面板](../assets/images/dns-win01.png)

2. 在控制面板界面点击 `查看网络状态和任务`，打开网络和共享中心  
![打开网络和共享中心](../assets/images/dns-win02.png)  

3. 在网络网络和共享中心界面点击左上角 `更改适配器设置`，打开网络连接界面  
![更改网络连接界面](../assets/images/dns-win03.png)

4. 在网络连接界面，选中正在使用的连接 > 点击右键 > 点击属性
![连接属性](../assets/images/dns-win04.png)

5. 在网络连接属性窗口中选中 `Internet 协议版本 4 (TCP/IPv4)` 然后点击“属性”。  
![打开设置](../assets/images/dns-win05.png)

6. 在设置界面，首先选中 `使用下面的 DNS 服务器地址(E)` ，随后在下方输入要使用的 DNS 服务器，最后点击确定设置完成。  
![设置 DNS](../assets/images/dns-win06.png)
...
## macOS
1. 选取苹果菜单 >“系统偏好设置”    
![打开系统偏好设置](../assets/images/dns-mac01.png)

2. 找到网络图标，点击进入  
![系统偏好设置](../assets/images/dns-mac02.png)

3. 从列表中选择想要使用的网络连接服务（例如 WIFI 或以太网），然后点按“高级”  
![选择连接](../assets/images/dns-mac03.png)

4. 找到DNS的标签，然后点击左下角“+”，填写希望使用的 DNS 服务器，之后点击"好"  
![设置 DNS](../assets/images/dns-mac04.png)

5. 返回到上一级，确认设置，并点击“应用”  
![确认与应用](../assets/images/dns-mac05.png)
